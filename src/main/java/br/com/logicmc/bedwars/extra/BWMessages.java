...
public enum BWMessages {
    ...
    PLAYER_LEAVE_INGAME,NEWPLAYER,CHOOSE_TEAM_ITEM, CHOOSE_TEAM_ITEM_LORE, SPECTATE_JOINNEXT, SPECTATE_JOINLOBBY, SPECTATE_PLAYERS, STAFF_ARENA_SPECTATE, MAXIMUM_UPGRADED, WORD_MAP, WORD_MODE, WORD_TEAM, TEAM_ALREADY_CHOSEN, WORD_COST, CLICK_BUY, SHOP_POTION, SHOP_BOW, SHOP_TNT, SHOP_EXTRA, QUICKSHOP, SHOP_ARMOR, LOWERTITLE_BED_DESTROYED, HEADTITLE_BED_DESTROYED, WORD_TARGET, HEADTITLE_VICTORY, LOWERTITLE_VICTORY, HEADTITLE_GAMELOST, LOWERTITLE_GAMELOST, UPGRADE_ARMOR_SOLO, UPGRADE_FORGERY_SQUAD, UPGRADE_ARMOR_SQUAD, UPGRADE_FORGERY_SOLO;
