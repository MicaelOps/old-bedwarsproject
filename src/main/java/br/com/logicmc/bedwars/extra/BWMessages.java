...
public enum BWMessages {
    ...
    GAME_STARTS_IN_MINITUES,GAME_STARTS_IN_SECONDS,SHOP_TOOLS,ERROR_MAXIMUM_UPGRADED,WORD_ONLINE,WORD_KILLS,WORD_TIME,WORD_CAPTURED,PREPOSITION_IN,
    ...
    PLAYER_LEAVE_INGAME,NEWPLAYER,CHOOSE_TEAM_ITEM, CHOOSE_TEAM_ITEM_LORE, SPECTATE_JOINNEXT, SPECTATE_JOINLOBBY, SPECTATE_PLAYERS, STAFF_ARENA_SPECTATE, MAXIMUM_UPGRADED, WORD_MAP, WORD_MODE, WORD_TEAM;
